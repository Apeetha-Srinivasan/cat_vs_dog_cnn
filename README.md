...
The goal of this project is to build a CNN model that can classify an input image as either a **Cat** or a **Dog**.
...
These visualizations helped me understand the model's performance during training and how well it generalized to unseen data.
...
Open the following notebook in VS Code:
